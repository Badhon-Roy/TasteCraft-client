            ...
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                {
                    reviews.map(review =>
                        <SwiperSlide key={review._id}>
                            <div className='text-center w-3/4 mx-auto space-y-2 my-16'>
                                ...
                                <div>
                                    <h2 className='flex justify-center lg:w-[100px] md:w-[70px] w-[50px] mx-auto'>{icon}</h2>
                                </div>
                                <p>{review?.details}</p>
                                <h2 className='text-2xl font-bold text-[#CD9003]'>{review?.name}</h2>
                            </div>
                        </SwiperSlide>
                    )
                }
